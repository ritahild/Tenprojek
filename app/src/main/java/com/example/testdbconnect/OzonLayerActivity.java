...
public class OzonLayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ozon_layer);

        TextView texter = this.findViewById(R.id.texter);
...
//                    Connection connection = DriverManager.getConnection("jdbc:postgres://user001:8fHaiwS6echZdthcKdJI2B2vTWvMmF5q@dpg-chpo7lqk728ivvp2sdm0-a.frankfurt-postgres.render.com/testdb_8mvz");
                    ...
                    ResultSet rs = st.executeQuery("SELECT layer_type,dt,layer_value FROM layer_data WHERE layer_type='ozone'");
                    String result = "";
                    while(rs.next()){
